...
export default function DealerProductGroupList({ products }) {
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    {groupedProducts.map((group) => (
                        ...
                        >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{group.productsInBox[0]?.distributorName}</td>
