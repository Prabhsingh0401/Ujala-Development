      ...
      <FilterGroup>
        ...
        {/* <FilterItem>
          <input
            ...
            className="w-full sm:w-48 pl-4 pr-4 py-2.5 border border-gray-200 bg-gray-50 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent text-sm"
          />
        </FilterItem> */}
      </FilterGroup>
